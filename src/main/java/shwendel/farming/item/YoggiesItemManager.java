...
import shwendel.farming.item.items.ability_items.EquipmentBagItem;
import shwendel.farming.item.items.equipment.HealingCharm;
import shwendel.farming.item.items.material.WheatItem;
import shwendel.farming.item.items.material.WheatSeedsItem;
...
public class YoggiesItemManager {
    ...
    static {
        ...
        // TODO Without Reflection, find a way to make these be forced to be added in order to compile ?

        ITEMS.put(YoggiesItemID.EQUIPMENT_BAG, new EquipmentBagItem());
        ITEMS.put(YoggiesItemID.HEALING_CHARM, new HealingCharm());
        ITEMS.put(YoggiesItemID.WHEAT, new WheatItem());
        ITEMS.put(YoggiesItemID.WHEAT_SEEDS, new WheatSeedsItem());
    ...
    public static YoggiesItem getItem(ItemStack item) {
        ...
        if(item == null) {
            return getItem(YoggiesItemID.NOTHING);
        }
